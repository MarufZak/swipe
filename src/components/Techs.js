  ...
  return <div className="techs section">
        <Container>
            ...
            <div className="techs__item">
                ...
                <img className="techs__item-img" sizes="35vw" src="./img/change/change@471.png" srcSet="./img/change/change@330.webp 330w, ./img/change/change@471.webp 471w," alt="triangles" />
            </div>
            </div>
        </Container>
    </div>
